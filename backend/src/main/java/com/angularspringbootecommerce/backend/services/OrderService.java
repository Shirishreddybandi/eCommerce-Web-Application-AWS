...
public class OrderService {
    ...
    public List<OrderDto> getOrdersByUserId(Long userId, Authentication authentication) {
        ...
        for (Order order : orders) {
            ...
            for (OrderItem item : order.getOrderItems()) {
                ...
                itemDto.setImgUrl(item.getProduct().getImgUrl());
    ...
    public Order createOrderFromCart(CartDto cart, Long userId, Authentication authentication) {
        ...
        order = orderRepository.save(order); // 💡 Save the order first to assign the ID
        ...
        // Set and save order items
        order.setOrderItems(orderItems);
        return orderRepository.save(order); // 💡 Save again to persist items
    }
