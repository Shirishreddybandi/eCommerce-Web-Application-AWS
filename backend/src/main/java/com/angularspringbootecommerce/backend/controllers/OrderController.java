...
import com.angularspringbootecommerce.backend.dtos.OrderItemDto;
...
//    }
    ...
    public ResponseEntity<List<OrderDto>> getOrdersByUserId(
        ...
        // ✅ Debugging output — confirms backend has items before serialization
        for (OrderDto o : orders) {
            System.out.println("DTO Order ID: " + o.getId());
            if (o.getOrderItems() != null) {
                System.out.println("  Items count: " + o.getOrderItems().size());
